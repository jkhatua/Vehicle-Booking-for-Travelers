                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="firstName" class="form-control"  placeholder="Employee's Name">
                                    <span class="help-block"> </span>
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="firstName" class="form-control"  placeholder="Father's Name">
                                    <span class="help-block"> </span>
                                  </div>
                                </div>
                              ...
                              <div class="row">
								...
								<div class="col-md-6">
                                  <div class="form-group ">
                                    ...
                                    <input type="text"  name="pan" style="text-transform:uppercase"  class="form-control"  placeholder="Enter Driving License Number">
                                    <span class="help-block">  </span>
                                  </div>
                                </div>
