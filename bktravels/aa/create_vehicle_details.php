                      ...
                      <div class="col-sm-12 col-xs-12">
                        <div class="form-wrap">
                          <form id="submit_seller" action="#" method="post" >
                            <div class="form-body">
                              <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Vehicle's Info</h6>
                              <hr class="light-grey-hr"/>
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label class="control-label mb-10">Vehicle Name</label>
                                    <input type="text" name="vehicle_name" id="vehicle_name" class="form-control"  placeholder="Vehicle's Name">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="vehicle_number" id="vehicle_number" class="form-control"  placeholder="Vehicle's Number">
                                    <span class="help-block"> </span>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group ">
                                    <label class="control-label mb-10">Date of Coming</label>
                              ...
                              <div class="row">
                              	<div class="col-md-6">
                                  <div class="form-group ">
                                    <label class="control-label mb-10">No of seater</label>
