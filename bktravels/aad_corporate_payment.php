      ...
      <div class="wrapper theme-4-active pimary-color-red">
         ...
         <div class="page-wrapper">
            <div class="container-fluid">
               ...
               <!-- /Title -->
               <form method="post" id="monthly_bill" action="ajax_submit_corporate.php" name="monthly_bill">
                  <div class="row">
                     <div class="col-md-12">
									...
									<?php }?>
                                                 ...
                                                 <div class="col-md-3">
                                                   <div class="form-group ">
                                                      ...
                                                      <select name="month" required class="form-control" onChange="getalldata()" id="month">
