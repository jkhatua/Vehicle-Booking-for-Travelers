                                ...
                                <div class="col-md-4" id="extra_hour_totalprice_div">
                                 ...
                                 <div class="col-md-4" id="night_haltdiv1">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="night_halt1" id="night_halt1" class="form-control" placeholder="Total Night Halt">
                                    <span class="help-block"> </span>
                                  </div>
                                </div>
...
$(document).on('blur', '#duty_slip_no', function()
            {
              ...
              ({
                ...
                success:function(response)
                {
                  ...
                  console.log(obj);
                 // alert(obj['place_to']);
                 $('#journey_from').val(obj['place_from']);
                      ...
                      ({
                        ...
                        success:function(response)
                        {
                          ...
                          if($("#charging_type").val()=="long")
                          {
                            ...
                            $('#detaintion_perhour_charges').val(obj1['detaintion_charges']);
                           var detaion_hour = $('#detaintion').val(); 
                            ...
                            var totalkm=$('#total_km').val();
                             var startdt = new Date($("#start_date").val() + " " + $("#starting_time").val());
							  ...
							  if(detaintion_hours<=0){detaintion_hours=0}
                           ...
                           var totalchargespaid = parseInt(obj.advance_paid_client);
                           var totalhavetopay = parseInt(tot_amnt) - parseInt(totalchargespaid);
                           var totalhavetopay1 = totalhavetopay + total_detaintion_charge + parseInt(tool_charge) + parseInt(parking_charge);
                           $('#total_adv').val(totalchargespaid);
                           //var totalchargespaid =totalchargespaid.toFixed();
                           $('#total_amount').val(totalhavetopay1);
							  $('#night_halt1').change(function(){
								  $('#night_halt').val(obj1['night_holt_charge']*$('#night_halt1').val());
								   var nighthalt=$('#night_halt').val();
								  totalhavetopay1 = totalhavetopay + total_detaintion_charge + parseInt(tool_charge) + parseInt(parking_charge) + parseInt(nighthalt);
								  //alert(totalhavetopay1);
								  $('#total_amount').val(totalhavetopay1);
							  });
                          ...
                          if($("#charging_type").val()=="local")
                          {
                                ...
                                if(mins>=30)
                                {
                                  ...
                                  if(minushour>0)
                                  {
                                    ...
                                    //var extrahour = hourtomin+30;
									  		//alert("a");
                                     var a = $('#extra_hour').val(minushour + " hours : " + 30 + " minutes  ");
                            ...
                            $("#fuel_rate").on("keyup change", function() 
                            {
                               ...
                               var totaladv=parseInt(obj.advance_paid_client);
                               $('#total_adv').val(totaladv);
                               var payamount=parseInt(totalamount)-parseInt(totaladv);
                               var extrahourcharge = $('#extra_hour_totalprice').val();
								var parking_charge=$('#parking').val();
                           		var tool_charge=$('#tool_gate').val();
								//alert(payamount);
                               var finalpayamount = payamount + parseInt(extrahourcharge)+ parseInt(tool_charge) + parseInt(parking_charge);
                            ...
                            if($("#charging_type").val()=="fixed")
                            {
                              ...
                              var totalchargespaid =parseInt(obj.advance_paid_client);
									var parking_charge=$('#parking').val();
                           var tool_charge=$('#tool_gate').val();	
                              var totalhavetopay = parseInt(tot_amnt) - parseInt(totalchargespaid)+ parseInt(tool_charge) + parseInt(parking_charge);
