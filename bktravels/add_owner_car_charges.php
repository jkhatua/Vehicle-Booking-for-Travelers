                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-sm-12 col-xs-12">
                        <div class="form-wrap">
                          <form id="submit_seller" action="ajax_add_owner_car_charges.php" method="post" >
                            <div class="form-body">
                ...
                <div class="col-md-6" id="nighthalt_div">
                                ...
                                <div class="col-md-6"  id="kmforlitrediv">
                                  <div class="form-group ">
                                    ...
                                    <input type="text"  name="km_cover_in_one_litre"  id="km_cover_in_one_litre" class="form-control" placeholder="Kilometer Cover in 1 Litre">
                                    <span class="help-block">  </span>
                                  </div>
                                </div>
