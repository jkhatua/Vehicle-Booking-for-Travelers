   ...
   function fetchownercarcharges($status,$id){
     ...
     $stmt = $mysqli->prepare("SELECT
       ...
       WHERE status = ? AND id = ?
        ...
        while($stmt->fetch()){
          $row[]=array('id'=>$id,'vehicle_id'=>$vehicle_id,'vehicle_name'=>$vehicle_name,'charging_type'=>$charging_type,'day_charge'=>$day_charge,'night_holt_charge'=>$night_holt_charge,'km_cover_in_one_litre'=>$km_cover_in_one_litre,'extra_hour_charges'=>$extra_hour_charges,'price_per_km'=>$price_per_km,'detaintion_charges'=>$detaintion_charges);
        }
        $stmt->close();
       if(!empty($row)){
       return ($row);
            ...
            <div class="panel-body">
               <div class="row">
                  <div class="col-sm-12 col-xs-12">
                     <div class="form-wrap">
                        <form id="form1" action="ajax_edit_customer_car_charges_submit.php" method="post" >
                           <div class="form-body">
                              <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Edit Customer's car charges</h6>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6" id="detaintion_div">
                                  <div class="form-group " >
                                    ...
                                    <input type='text' name="detaintion_charges" id="detaintion_charges" class="form-control"  value="<?php echo $v2['detaintion_charges']; ?>">
                                    <span class="help-block">  </span>
                                  </div>
                                </div>
   ...
   frm.submit(function (e) {
       ...
       $.ajax({
           ...
           success: function (data) {
            window.location.href = "customer_car_charges.php";
