									...
									<div class="panel-body">
                                      ...
                                      <?php }?>
														...
														<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group ">
																		<label class="control-label mb-10">S.O. Number</label>
										...
										<div class="table-wrap">
											<table id="POITable"  data-toggle="table"  >
												...
												<tbody >
													...
													<td><input type='text' style='width:40px;background-color: #212121;color:#fff;'  class="cgst_cls"  id="cgst-0"  name="cgst[]"></td>
													<td><input type='text' style='width:40px;background-color: #212121;color:#fff;'  class="sgst_cls"  id="sgst-0" name="sgst[]" readonly></td>
													<td><input type='text' style='width:40px;background-color: #212121;color:#fff;'  class="igst_cls"  id="igst-0" name="igst[]"></td>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group ">
														<label class="control-label mb-10">Due Balance</label>
														<div class="input-group mb-15"> <span class="input-group-addon"><i class="fa fa-inr"></i></span>
														<input type="text" style="background-color:#212121" name="freight" class="form-control" placeholder="Due Balance">
													</div>
														<span class="help-block">  </span>
													</div>
												</div>
	  ...
	  <!-- Bootstrap Daterangepicker JavaScript -->
		...
		<script>
				...
				function deleteRow(row)
					...
					$(document).on('click', '.add-row', function(){
						...
						$('#add_tr').replaceWith('');
							...
							$('.add_tr').replaceWith('<tr class="table-align" id="row-'+z+'"><td><input type="text" name="sl_no[]" class="sl_no_cls" id="sl_no-'+z+'" style="text-align:center;width:40px;background-color: #212121;color:#fff;" value="'+(z+1)+'"/></td><td><input type="text" name="mat_des[]" class="mat_code_clss" id="mat_code-'+z+'" style="width:90px;background-color: #212121;color:#fff;"/></td><td><input type="text" name="mat_code[]" class="mat_des_clss" id="mat_des-'+z+'" style="width:90px;background-color: #212121;color:#fff;"/></td><td><input type="text" name="hsn_code[]" class="hsn_code_cls" id="hsn_code-'+z+'" style="width:60px;background-color: #212121;color:#fff;"/></td><td><input type="text" name="cgst[]"  class="cgst_cls" id="cgst-'+z+'" style="width:40px;background-color: #212121;color:#fff;"/></td><td><input type="text" name="sgst[]" class="sgst_cls" id="sgst-'+z+'" style="width:40px;background-color: #212121;color:#fff;"/></td><td><input type="text" name="igst[]" class="igst_cls" id="igst-'+z+'" style="width:40px;background-color: #212121;color:#fff;"/></td><td><input type="number" name="quantity[]" class="quantity_cls" id="quantity-'+z+'" style="width:60px;background-color: #212121;color:#fff;" /></td><td><input type="text" name="rate[]" class="rate_cls" id="rate-'+z+'" style="width:60px;background-color: #212121;color:#fff;"/></td><td><input type="text" name="discount[]" class="discount_cls" id="discount-'+z+'" style="width:50px;background-color: #212121;color:#fff;" /></td><td><input type="text" name="amount[]" class="amount_cls" id="amount-'+z+'" style="width:60px;background-color: #212121;color:#fff;" /></td><td><input type="text" name="tax_cost[]" class="tax_cls" id="tax_cost-'+z+'" style="width:80px;background-color: #212121;color:#fff;" /></td><td><a href="javascript:void(0)" class="mr-15 add-row" id="addrow-0"><i class="fa fa-pencil	 text-inverse m-r-10"></i></a><a onclick="deleteRow(this);" data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-close  text-danger"></i> </a></td></tr><tr class="add_tr"></tr>');
								return false;
					});
					});
				...
				function totalAmount2(i,j)
				{
									...
									var new_new_balance = parseFloat(Math.round(new_balance * 100) / 100).toFixed(2);
									//alert(new_balance);
									$('#tax_cost-'+i).val(new_new_balance);
					...
					$(document).on('keyup', '.discount_cls', function(){
					   		...
					   		finalAmount = parseFloat(finalAmount) + parseFloat($("#tax_cost-"+i).val());
								var new_tax_amount = parseInt(Math.round(finalAmount * 100) / 100).toFixed(2);
							}
								$('#tot_cost').val(new_tax_amount);
				});
