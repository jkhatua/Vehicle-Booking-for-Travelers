                      ...
                      <div class="col-sm-12 col-xs-12">
                        <div class="form-wrap">
                          <form id="submit_seller" action="ajax_submit_dutyslip.php" method="post" >
                            <div class="form-body">
                              <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Add Duty Slip Details<a href="create_dutyslip_corporate.php" style="float: right" class="link_btn">Add Corporate Dutyslip</a></h6>
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group ">
                                      ...
                                      <option value="<?php echo $v2['id']."$".$v2['size']."$".$v2['vehicle_name'];?>"><?php echo $v2['vehicle_name'];?></option>
                                      <?php }?>
                                    </select>
                                      <span class="help-block"> </span>
                                    </div>
