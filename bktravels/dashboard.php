...
//   ");
//   $stmt->execute();
//   $stmt->bind_result($invoice_no,$code,$date,$mat_des,$quantity,$amount,$mat_code);
//   while ($stmt->fetch()) {
//     $row[] = array('invoice_no' => $invoice_no,'code'=>$code,'date'=>$date,'mat_des'=>$mat_des,'quantity'=>$quantity,'amount'=>$amount,'mat_code'=>$mat_code );
//   }
//   $stmt->close();
//   if(!empty($row))
//   {
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													...
													<span class="txt-light block counter"><i class="fa fa-inr" aria-hidden="true"></i><span class="counter-anim"></span></span>
												</div>
										...
										<div class="">
											...
											<div class="pl-15 pr-15 mb-15">
												<div class="pull-left">
													...
													<span class="inline-block txt-danger pull-right weight-500"></span>
												<div class="clearfix"></div>
											</div>
											<hr class="light-grey-hr mt-0 mb-15"/>
											<div class="pl-15 pr-15 mb-15">
												...
												<span class="inline-block txt-primary pull-right weight-500"></span>
												<div class="clearfix"></div>
											</div>
										</div>
									</div>
