...
--
-- Host: 127.0.0.1
-- Generation Time: May 26, 2018 at 04:03 PM
...
(5, 'corporate1', 9876789876, 'corporate1@gmail.com', 'bbsr', 1, '2018-05-21 07:30:29'),
(6, 'corporate2', 9876567898, 'corporate2@gmail.com', 'tjrhnj', 1, '2018-05-21 12:57:44');
...
--
-- Table structure for table `creditor_report`
--

CREATE TABLE `creditor_report` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `vehicle_type` varchar(555) NOT NULL,
  `destination` varchar(555) NOT NULL,
  `dutyno` bigint(11) NOT NULL,
  `report_person` varchar(555) NOT NULL,
  `billno` bigint(11) NOT NULL,
  `total` bigint(11) NOT NULL,
  `advance` bigint(11) NOT NULL,
...
--
-- Dumping data for table `creditor_report`
--

INSERT INTO `creditor_report` (`id`, `date`, `vehicle_type`, `destination`, `dutyno`, `report_person`, `billno`, `total`, `advance`, `balance`, `status`, `entrytime`) VALUES
(5, '2018-05-26', 'sadsad', 'dsadsa', 1, '4324', 1, 2, 21343, 34, 1, '2018-05-26 11:01:26'),
(6, '2018-05-14', 'dfsd', 'sdfsd', 2432, '324', 324, 324, 234, 423, 1, '2018-05-26 11:01:47');
...
INSERT INTO `duitysliprecord` (`id`, `date`, `dityslipno`, `bookedby`, `driver_name`, `totalkm`, `status`, `insertdate`, `guest_name`, `vehicle_no`, `total_time`, `vehicle_name`, `drop_location`, `owner_slip_no`, `o_p`, `travel_advance`, `guest_advance`, `toll`, `netadvance`, `cash_return`) VALUES
(1, '2018-05-26', 12345, 'rakesh', 'driver name', 400, '0', '2018-05-26 06:45:11', 'rakesh pothal', 'or-01-t3095', '0 days : 1 hours : 40 minutes : 0 seconds', 'Honda City', 'ctc', 5555555, '', 800, 500, 50, 1300, 50),
(2, '2018-05-26', 1258, 'booked by', 'gggggggggg', 130, '1', '2018-05-26 06:57:37', 'corporate2', 'or-01-t3095', '0 days : 1 hours : 40 minutes : 0 seconds', 'tata safari', 'ssssssss', 12548, '', 100, 200, 40, 300, 50);
...
INSERT INTO `duty_slip_corporate` (`id`, `dutyslip_slno`, `corporate_id`, `corporate_name`, `report_at`, `booked_by`, `vehicle_no`, `vehicle_id`, `vehicle_name`, `vehicle_size`, `driver_name`, `place_from`, `place_to`, `start_date`, `starting_km`, `start_time`, `closing_km`, `closing_time`, `closing_date`, `total_km`, `total_time`, `charging_type`, `ac_nonac`, `toll_gate`, `parking_charge`, `advance_paid_client`, `advance_paid_travel`, `created_date`, `monthof`, `yearof`, `advance_return_driver`, `paid_to_owener`, `remarks`, `ownerslipno`) VALUES
(6, 1258, '6', 'corporate2', 'report togfghf', 'booked by', 'or-01-t3095', '2', 'tata safari', '', 'gggggggggg', 'ssssssss', 'ssssssss', '2018-05-26', '100', '08:56', '230', '10:36', '2018-05-26', '130', '0 days : 1 hours : 40 minutes : 0 seconds', '', 'nonac', '40', '20', '100.00', '200.00', '2018-05-26 14:00:25', 5, 2018, 50, 100, 'remarks herezfvxcvbxcbxcb', 12548);
...
--
-- Indexes for table `creditor_report`
--
ALTER TABLE `creditor_report`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `creditor_report`
--
ALTER TABLE `creditor_report`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
