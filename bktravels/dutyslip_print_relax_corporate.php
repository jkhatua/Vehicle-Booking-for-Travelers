...
$dutyslip_details = duityslip_details($printid)	;
	...
	function corporate_list($corporateid){
	global $mysqli;
	$stmt = $mysqli->prepare("SELECT
	address
	 FROM aacorporate
	...
	$corporateid = $dutyslip_details['corporate_id'];
	//echo($corporateid);
	$cr_details = corporate_list($corporateid);
	//print_r($cr_details);
	//print("<pre>");
...
<tr>
  ...
  <tr>
   <td colspan="5" style="padding-left:50px; border: none">
  		<br>
   		<span class="position-left">Name of the Guest/Off  </span><span class="span_class"><?php echo($dutyslip_details['corporate_name']); ?></span></span><br><br>
   		<span class="position-left">Address </span><span class="span_class"><?php echo($cr_details['address']); ?></span></span><br><br>
