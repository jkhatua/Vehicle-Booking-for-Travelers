...
//echo($dutyslip_no);
//print("<pre>");
$sql = mysqli_query($con,"SELECT * FROM `duty_slip` WHERE `dutyslip_slno`='$dutyslip_no'");
                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-sm-12 col-xs-12">
                        <div class="form-wrap">
                          <form id="submit_seller" action="ajax_submit_dutyslip_update.php" method="post" >
                            <div class="form-body">
                              ...
                              <div class="row">
                                <div class="col-md-3">
                                  <div class="form-group">
                                    ...
                                    value="<?php echo($rowdata['dutyslip_slno']); ?>" style="background-color: black;" >
                                ...
                                <div class="col-md-3">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="duty_of" id="duty_of" class="form-control"  placeholder="Duty of" value="<?php echo($rowdata['duty_of']); ?>">
                                    <span class="help-block"> </span>
                                  </div>
                                </div>
                                <div class="col-md-3">
                                  <div class="form-group ">
                                    ...
                                    <input type="text"  maxlength="50" name="report_at"  class="form-control"  placeholder="Report at" value="<?php echo($rowdata['report_at']); ?>">
                                    <span class="help-block"> </span>
                                  </div>
                                </div>
								              <div class="col-md-3">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group ">
                                      ...
                                      <option <?php if($v2['id']== $rowdata['vehicle_id'])echo("selected") ?> value="<?php echo $v2['id']."$".$v2['size']."$".$v2['vehicle_name'];?>"><?php echo $v2['vehicle_name'];?></option>
                                      <?php }?>
                                    </select>
                                      <span class="help-block"> </span>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                      ...
                                      <select name="vehicle_no" id="vehicle_no" class="form-control" >
                                      	<option value="<?php echo($rowdata['vehicle_no']) ?>"><?php echo($rowdata['vehicle_no']) ?></option>
                                    ...
                                    <div class="form-group ">
                                      ...
                                      <input type="text" name="driver_name" class="form-control" required  value="<?php echo($rowdata['driver_name']); ?>">
                                ...
                                <div class="col-md-4">
                                  <div class="form-group ">
                                    ...
                                    <input type="text"   name="charging_type"  id="charging_type" class="form-control"  value="<?php echo($rowdata['charging_type']); ?>" >
     ...
     frm.submit(function (e) {
          ...
          $.ajax({
              ...
              success: function (data) {
                 //swal("Good job!", "Vehicle Details Successfully Updated!!", "success")
				          //alert (data);
				 
                 //$('#submit_seller')[0].reset();
				 window.location.replace("all_duityslip_view.php");
              },
              error: function (data) {
