                          ...
                          if(!empty($fetchResult)) { ?>
													...
													<tbody>
														...
														<tr>
															...
															<td class="text-nowrap"><a href="monthly_bill_print.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;</a> <a onClick="delete_buyer(<?php echo $v1['id'];?>);" data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-close  text-danger"></i> </a> </td>
														</tr>
															<?php $i++; } ?>
													</tbody>
  ...
  <script src="vendors/bower_components/sweetalert/dist/sweetalert.min.js"></script>
	...
	<script>
		...
		function delete_buyer(val){
			$.ajax({
			type: "POST",
			url: "ajax_delete_office_bill.php",
			data:'id='+val,
