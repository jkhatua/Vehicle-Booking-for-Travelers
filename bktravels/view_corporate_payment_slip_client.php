                          ...
                          if(!empty($fetchResult)) { ?>
													...
													<tbody>
														...
														<tr>
															...
															<td class="text-nowrap"><a href="monthly_bill_print_corporate_client.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;</a> 
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-body">
														<form action="ajax_pay_pending_amount_corporate_client.php" method="POST">
  ...
  <script src="vendors/bower_components/sweetalert/dist/sweetalert.min.js"></script>
	...
	<script>
		...
		function delete_buyer(val){
			$.ajax({
			type: "POST",
			url: "ajax_delete_office_bill_client.php",
			data:'id='+val,
