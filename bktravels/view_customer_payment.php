            ...
            <div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h5 class="txt-dark">View Customer Payment Slip</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							<li><a href="dashboard.php">Dashboard</a></li>
							<li class="active"><span>View Customer Payment Slip</span></li>
						</ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">View Customer Payment Slip</h6>
								</div>
											...
											<table id="datable_1" class="table  display table-hover mb-30">
												...
												<tbody>
													...
													<tr>
														...
														<td><a href="customer_archieve.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>
														</a>&nbsp; &nbsp;<a  data-toggle="modal" data-id="<?php echo $v1['duty_slip_no']?>"
data-amount="<?php echo $v1['total_amount']?>" data-target="#exampleModal"  class="open-AddBookDialog mr-25" data-toggle="tooltip" data-original-title="Pay"><i class="fa fa-cc-mastercard  text-danger"></i> </a></td>
														<!-- <td class="text-nowrap"><a onClick="delete_buyer(<?php ?>);" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-close text-danger"></i></a></td> -->
													</tr>
													  <?php $i++; } ?>
												</tbody>
											</table>
